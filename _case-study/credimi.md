...
Porcu began looking for microservice architecture that was new and Docker-native. Instead of turning to Jenkins, he chose Codefresh – the first CI/CD platform built for [**Kubernetes**](/technology/kubernetes/). As one of Codefresh’s first customers, Credimi enjoyed faster builds and deployments, complexity reduction and automation in a fully cloud-based architecture.
...
Two of Porcu’s top engineers began worked with the [**Skill Sprint**](/product/skill-sprint) leader over one-week to achieve these crucial steps of migration and knowledge transfer.
